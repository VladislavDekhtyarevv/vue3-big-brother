...
/&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="options" tabindex="-1"><a class="header-anchor" href="#options" aria-hidden="true">#</a> Options</h3><table><thead><tr><th>Directive</th><th>Type</th><th>Description</th></tr></thead><tbody><tr><td>width</td><td>number</td><td>Image width in pixels</td></tr><tr><td>avatar</td><td>require</td><td>Url image</td></tr><tr><td>left-eye</td><td>object</td><td>Location of the left eye</td></tr><tr><td>right-eye</td><td>object</td><td>Location of the right eye</td></tr><tr><td>diameter-left-eye</td><td>number</td><td>Eye rotation diameter</td></tr><tr><td>diameter-right-eye</td><td>number</td><td>Eye rotation diameter</td></tr></tbody></table>`,15),n=[a];function o(s,l){return t(),i("div",null,n)}const h=e(d,[["render",o],["__file","index.html.vue"]]);export{h as default};
